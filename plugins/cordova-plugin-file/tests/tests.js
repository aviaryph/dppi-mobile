    ...
    describe('File API', function () {
        ...
        if (cordova.platformId === 'android') { // eslint-disable-line no-undef
            describe('content: URLs', function () {
                // Warning: Default HelloWorld www directory structure is required for these tests (www/dashboard.html at least)
                ...
                it('file.spec.138 copyTo: content', function (done) {
                    testContentCopy('content://org.apache.cordova.file.testprovider/www/dashboard.html', done);
                });
                ...
                it('file.spec.140 delete: content should fail', function (done) {
                    resolveLocalFileSystemURL('content://org.apache.cordova.file.testprovider/www/dashboard.html', function (entry) { // eslint-disable-line no-undef
            ...
            describe('asset: URLs', function () {
                ...
                it('file.spec.143 copyTo: asset -> temporary', function (done) {
                    ...
                    var transfer = function () {
                        resolveLocalFileSystemURL('file:///android_asset/www/dashboard.html', function (entry) { // eslint-disable-line no-undef
